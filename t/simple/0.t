...
{ stderr => $serr, status => $fafs->{Status}, method => $fafs->{method},
  mark => $fafs->{mark},                  location => $fafs->{location} },
...
{ rv => qq|$fafs|, stderr => $serr, status => $fafs->{Status},
  method => $fafs->{method},            mark => $fafs->{mark},
                                location => $fafs->{location} },
...
is_deeply
{ stderr => $serr,   status => $fafs->{Status},   method => $fafs->{method},
  mark => $fafs->{mark}, location => $fafs->{location}, exists => !-d $dirc },
...
is_deeply
{ stderr => $serr,   status => $fafs->{Status},   method => $fafs->{method},
  mark => $fafs->{mark}, location => $fafs->{location}, exists => !-e $dirc },
